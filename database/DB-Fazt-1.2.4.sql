...
COMMENT ON COLUMN project_category.id IS 'Llave primaria.';
COMMENT ON COLUMN project_category.id_category IS 'Llave foránea de category.';
COMMENT ON COLUMN project_category.id_project IS 'Llave foránea de project.';
CREATE TABLE rol (
  id       SERIAL NOT NULL, 
...
ALTER TABLE project_category ADD CONSTRAINT fk_project_category FOREIGN KEY (id_category) REFERENCES category (id);
ALTER TABLE project_category ADD CONSTRAINT fk_category_project FOREIGN KEY (id_project) REFERENCES project (id);
